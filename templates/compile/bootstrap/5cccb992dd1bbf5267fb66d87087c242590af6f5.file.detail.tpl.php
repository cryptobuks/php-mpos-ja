<?php /* Smarty version Smarty-3.1.16, created on 2018-09-30 19:14:33
         compiled from "/var/www/mpos/templates/bootstrap/account/edit/detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19691346485baf5086a0ff88-32658220%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5cccb992dd1bbf5267fb66d87087c242590af6f5' => 
    array (
      0 => '/var/www/mpos/templates/bootstrap/account/edit/detail.tpl',
      1 => 1538295265,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19691346485baf5086a0ff88-32658220',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5baf5086abebc9_06470220',
  'variables' => 
  array (
    'CTOKEN' => 0,
    'GLOBAL' => 0,
...
<?php if ($_valid && !is_callable('content_5baf5086abebc9_06470220')) {function content_5baf5086abebc9_06470220($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/var/www/mpos/public/../include/smarty/libs/plugins/function.html_options.php';
  ...
  <div class="col-lg-6">
    <div class="panel panel-info">
      <div class="panel-heading">
        <i class="fa fa-edit fa-fw"></i> Account Details/アカウント情報
      </div>
...
"><?php echo $_smarty_tpl->tpl_vars['GLOBAL']->value['userdata']['api_key'];?>
            ...
            <div class="form-group">
              <label>Payment Address/払出アドレス</label>
...
" size="40" <?php if ($_smarty_tpl->tpl_vars['GLOBAL']->value['twofactor']['enabled']&&$_smarty_tpl->tpl_vars['GLOBAL']->value['twofactor']['options']['details']&&!$_smarty_tpl->tpl_vars['DETAILSUNLOCKED']->value) {?>id="disabledInput" disabled<?php }?>/>
            ...
            <div class="form-group">
              <label>Donation Percentage/寄付率</label>
              <font size="1"> Donation amount in percent/寄付をする量を設定します (<?php echo $_smarty_tpl->tpl_vars['DONATE_THRESHOLD']->value['min'];?>
 - 100%)</font>
...
" size="4" <?php if ($_smarty_tpl->tpl_vars['GLOBAL']->value['twofactor']['enabled']&&$_smarty_tpl->tpl_vars['GLOBAL']->value['twofactor']['options']['details']&&!$_smarty_tpl->tpl_vars['DETAILSUNLOCKED']->value) {?>id="disabledInput" disabled<?php }?>/>
            ...
            <div class="form-group">
              <label>Automatic Payout Threshold/自動払出設定</label>
              </br>
...
. Set to '0' for no auto payout./0にすると自動払出はされません。<?php if ($_smarty_tpl->tpl_vars['GLOBAL']->value['config']['txfee_auto']>0) {?> A <?php if ($_smarty_tpl->tpl_vars['GLOBAL']->value['config']['txfee_auto']>0.00001) {?><?php echo $_smarty_tpl->tpl_vars['GLOBAL']->value['config']['txfee_auto'];?>
...
<?php }?>" <?php if ($_smarty_tpl->tpl_vars['GLOBAL']->value['twofactor']['enabled']&&$_smarty_tpl->tpl_vars['GLOBAL']->value['twofactor']['options']['details']&&!$_smarty_tpl->tpl_vars['DETAILSUNLOCKED']->value) {?>id="disabledInput" disabled<?php }?>/>
            ...
            <div class="form-group">
              <label>Anonymous Account/アカウントを匿名化</label>
              ...
              <font size="1">Hide username on website from others. Admins can still get your user information./設定するとユーザー名がサイト上で表示されません。なお、管理者は閲覧可能です。</font>
            </div>
            <div class="form-group">
              <label>4 Digit PIN/4桁のPINコード</label>
              <font size="1">The 4 digit PIN you chose when registering/登録時に入力した4桁のPINコード</font>
