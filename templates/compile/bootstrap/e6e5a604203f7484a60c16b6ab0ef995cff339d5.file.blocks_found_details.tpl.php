<?php /* Smarty version Smarty-3.1.16, created on 2018-09-30 12:13:09
         compiled from "/var/www/mpos/templates/bootstrap/statistics/blocks/blocks_found_details.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5940267845bafa7a93aace9-18829535%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e6e5a604203f7484a60c16b6ab0ef995cff339d5' => 
    array (
      0 => '/var/www/mpos/templates/bootstrap/statistics/blocks/blocks_found_details.tpl',
      1 => 1538286850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5940267845bafa7a93aace9-18829535',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5bafa7a94365d7_70424523',
  'variables' => 
  array (
    'BLOCKLIMIT' => 0,
    'GLOBAL' => 0,
...
<?php if ($_valid && !is_callable('content_5bafa7a94365d7_70424523')) {function content_5bafa7a94365d7_70424523($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/mpos/public/../include/smarty/libs/plugins/modifier.date_format.php';
...
<?php }?></td>
                ...
                <?php $_smarty_tpl->tpl_vars["totalexpectedshares"] = new Smarty_variable($_smarty_tpl->tpl_vars['totalexpectedshares']->value+$_smarty_tpl->tpl_vars['BLOCKSFOUND']->value[$_smarty_tpl->getVariable('smarty')->value['section']['block']['index']]['estshares'], null, 0);?>
                  <?php echo number_format($_smarty_tpl->tpl_vars['BLOCKSFOUND']->value[$_smarty_tpl->getVariable('smarty')->value['section']['block']['index']]['estshares'],$_smarty_tpl->tpl_vars['GLOBAL']->value['config']['sharediffprecision']);?>

                </td>
                <?php if ($_smarty_tpl->tpl_vars['GLOBAL']->value['config']['payout_system']=='pplns') {?>
                <td class="text-right"><?php echo number_format($_smarty_tpl->tpl_vars['BLOCKSFOUND']->value[$_smarty_tpl->getVariable('smarty')->value['section']['block']['index']]['pplns_shares'],$_smarty_tpl->tpl_vars['GLOBAL']->value['config']['sharediffprecision']);?>
</td>
                <?php }?>
                ...
                <td class="text-right">
                  ...
                  <font color="<?php if (($_smarty_tpl->tpl_vars['percentage']->value<=100)) {?>green<?php } elseif (($_smarty_tpl->tpl_vars['percentage']->value<=115)) {?>orange<?php } else { ?>red<?php }?>"><?php echo number_format($_smarty_tpl->tpl_vars['percentage']->value,"2");?>
</font>
                </td>
              </tr>
              <?php endfor; endif; ?>
              <tr>
                ...
                <td class="text-right"><?php echo number_format($_smarty_tpl->tpl_vars['totalexpectedshares']->value,$_smarty_tpl->tpl_vars['GLOBAL']->value['config']['sharediffprecision']);?>
</td>
                <?php if ($_smarty_tpl->tpl_vars['GLOBAL']->value['config']['payout_system']=='pplns') {?>
                <td class="text-right"><?php echo number_format($_smarty_tpl->tpl_vars['pplnsshares']->value,$_smarty_tpl->tpl_vars['GLOBAL']->value['config']['sharediffprecision']);?>
</td>
                <?php }?>
                <td class="text-right"><?php echo number_format($_smarty_tpl->tpl_vars['totalshares']->value,$_smarty_tpl->tpl_vars['GLOBAL']->value['config']['sharediffprecision']);?>
</td>
                <td class="text-right"><?php if ($_smarty_tpl->tpl_vars['count']->value>0) {?><font color="<?php if ((($_smarty_tpl->tpl_vars['totalshares']->value/$_smarty_tpl->tpl_vars['totalexpectedshares']->value*100)<=100)) {?>green<?php } elseif ((($_smarty_tpl->tpl_vars['totalshares']->value/$_smarty_tpl->tpl_vars['totalexpectedshares']->value*100)<=115)) {?>orange<?php } else { ?>red<?php }?>"><?php echo number_format(($_smarty_tpl->tpl_vars['totalshares']->value/$_smarty_tpl->tpl_vars['totalexpectedshares']->value*100),"2");?>
