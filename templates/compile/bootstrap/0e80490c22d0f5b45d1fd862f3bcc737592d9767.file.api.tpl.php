<?php /* Smarty version Smarty-3.1.16, created on 2018-09-30 18:26:04
         compiled from "/var/www/mpos/templates/bootstrap/dashboard/js/api.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14352236155baf50803393e2-33113220%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0e80490c22d0f5b45d1fd862f3bcc737592d9767' => 
    array (
      0 => '/var/www/mpos/templates/bootstrap/dashboard/js/api.tpl',
      1 => 1538286850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14352236155baf50803393e2-33113220',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5baf50803c0f77_33086662',
  'variables' => 
  array (
    'PATH' => 0,
    'GLOBAL' => 0,
...
<?php if ($_valid && !is_callable('content_5baf50803c0f77_33086662')) {function content_5baf50803c0f77_33086662($_smarty_tpl) {?><script type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['PATH']->value;?>
...
$(document).ready(function(){
  ...
  // don't create object and hide toggle on mobile devices. must be started inside a touch event, else sound doesn't start
    ...
    if (playSound == 'True') {
      var audioPath = "<?php echo $_smarty_tpl->tpl_vars['PATH']->value;?>
/audio/";
...
";
  ...
  var storedPersonalHashrate = [ null, null, null, null, null, null, null, null, null, null, null, null, <?php echo round($_smarty_tpl->tpl_vars['GLOBAL']->value['userdata']['hashrate'],"2");?>
 ];
  var storedPersonalSharerate = [ null, null, null, null, null, null, null, null, null, null, null, null, <?php echo round($_smarty_tpl->tpl_vars['GLOBAL']->value['userdata']['sharerate'],$_smarty_tpl->tpl_vars['GLOBAL']->value['config']['sharediffprecision']);?>
 ];
  var storedPoolHashrate = [ null, null, null, null, null, null, null, null, null, null, null, null, <?php echo round($_smarty_tpl->tpl_vars['GLOBAL']->value['hashrate'],"2");?>
 ];
  var storedNetHashrate = [ null, null, null, null, null, null, null, null, null, null, null, null, <?php echo round($_smarty_tpl->tpl_vars['GLOBAL']->value['nethashrate'],"2");?>
 ];
  var storedPoolWorkers = [ null, null, null, null, null, null, null, null, null, null, null, null, <?php echo $_smarty_tpl->tpl_vars['GLOBAL']->value['workers'];?>
 ];
  var storedCoinPrice = [ null, null, null, null, null, null, null, null, null, null, null, null,
                          null, null, null, null, null, null, null, null, null, null, null, null,
                          null, null, null, null, null, null, null, null, null, null, null, null,
                          <?php echo $_smarty_tpl->tpl_vars['GLOBAL']->value['price'];?>
 ];
  var lastBlock = 0;
  ...
  var sparklineLineOptions = {
    height: '35',
    chartRangeMin: <?php echo $_smarty_tpl->tpl_vars['GLOBAL']->value['price'];?>
 - 5,
    chartRangeMax: <?php echo $_smarty_tpl->tpl_vars['GLOBAL']->value['price'];?>
 + 5,
    composite: false,
    lineColor: 'black',
    fillColor: '#41fc41',
...
<?php }?>
  ...
  function refreshInformation(data) {
    ...
    storedPersonalSharerate.push(parseFloat(data.getdashboarddata.data.personal.sharerate).toFixed(<?php echo $_smarty_tpl->tpl_vars['GLOBAL']->value['config']['sharediffprecision'];?>
))
  ...
  <?php }?>
    ...
    $('#b-sharerate').html((parseFloat(data.getdashboarddata.data.personal.sharerate).toFixed(<?php echo $_smarty_tpl->tpl_vars['GLOBAL']->value['config']['sharediffprecision'];?>
)));
    $('#b-yvalid').html(number_format(data.getdashboarddata.data.personal.shares.valid, <?php echo $_smarty_tpl->tpl_vars['GLOBAL']->value['config']['sharediffprecision'];?>
));
    $('#b-yivalid').html(number_format(data.getdashboarddata.data.personal.shares.invalid, <?php echo $_smarty_tpl->tpl_vars['GLOBAL']->value['config']['sharediffprecision'];?>
));
    ...
    $('#b-pvalid').html(number_format(data.getdashboarddata.data.pool.shares.valid, <?php echo $_smarty_tpl->tpl_vars['GLOBAL']->value['config']['sharediffprecision'];?>
));
    $('#b-pivalid').html(number_format(data.getdashboarddata.data.pool.shares.invalid, <?php echo $_smarty_tpl->tpl_vars['GLOBAL']->value['config']['sharediffprecision'];?>
));
    ...
    $('#b-payout').html(number_format(data.getdashboarddata.data.personal.estimates.payout, <?php echo $_smarty_tpl->tpl_vars['PRECISION']->value;?>
));
    $('#b-block').html(number_format(data.getdashboarddata.data.personal.estimates.block, <?php echo $_smarty_tpl->tpl_vars['PRECISION']->value;?>
));
    $('#b-fee').html(number_format(data.getdashboarddata.data.personal.estimates.fee, <?php echo $_smarty_tpl->tpl_vars['PRECISION']->value;?>
));
    $('#b-donation').html(number_format(data.getdashboarddata.data.personal.estimates.donation, <?php echo $_smarty_tpl->tpl_vars['PRECISION']->value;?>
));
<?php } else { ?>
    ...
    $('#b-est1').html(number_format(data.getdashboarddata.data.personal.estimates.hours1, <?php echo $_smarty_tpl->tpl_vars['PRECISION']->value;?>
));
    $('#b-est24hours').html(number_format(data.getdashboarddata.data.personal.estimates.hours24, <?php echo $_smarty_tpl->tpl_vars['PRECISION']->value;?>
));
    $('#b-est7days').html(number_format(data.getdashboarddata.data.personal.estimates.days7, <?php echo $_smarty_tpl->tpl_vars['PRECISION']->value;?>
));
    $('#b-est14days').html(number_format(data.getdashboarddata.data.personal.estimates.days14, <?php echo $_smarty_tpl->tpl_vars['PRECISION']->value;?>
));
    $('#b-est30days').html(number_format(data.getdashboarddata.data.personal.estimates.days30, <?php echo $_smarty_tpl->tpl_vars['PRECISION']->value;?>
));
<?php }?>
